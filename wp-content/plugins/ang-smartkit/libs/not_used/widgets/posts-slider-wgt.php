<?php
/*
 * Plugin Name: ANG Blog Posts Slider
...
class ANGPostsSlider extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'ANG-Posts-Slider', // Base ID
            esc_html__('ANG Posts Slider', 'ang-plugins'), // Name
            array( 'description' => esc_html__( 'Widget, displays blog posts in slider style.', 'ang-plugins' ), ) // Args
        );
    }
...
<!--        infinite scroll true or false-->
    ...
    <div class="ang-postnews-slider <?php echo $instance['ItemCount']; ?>">
...
add_action('widgets_init', create_function('', 'return register_widget("ANGPostsSlider");')); ?>