 ...
 */
function ang_shortcode_listing_search_callback( $atts ) {
	...
	if(!empty($selected_post_types)):
		if(count($selected_post_types) > 1):
			...
			foreach($selected_post_types as $post_type):
				...
				echo '<li data-tab="epl_ps_tab_'.$uniqid.'_'.$tabcounter.'" class="tab-link '.$is_sb_current.'">'.$post_type_label.'</li>';
				$tabcounter++;
	...
	<div class="epl-search-forms-wrapper epl-search-<?php echo $style; ?>">
		...
		?>
                ...
                <div class="epl-search-form <?php echo $is_sb_current; ?>" id="epl_ps_tab_<?php echo $uniqid.'_'.$tabcounter; ?>">
...
if($epl_active){
    remove_shortcode( 'listing_search');
    add_shortcode( 'listing_search', 'ang_shortcode_listing_search_callback' );
}
