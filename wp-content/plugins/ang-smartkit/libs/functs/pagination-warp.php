 ...
 * subpackage Pagination for custom post types, shortcodes and custom widgets.
 ...
 */
if (!function_exists('ang_warp_pagination')) {

    function ang_warp_pagination($wp_query) {
        ...
        if ($pages > 1) {
            ...
            $output[] = '<ul class="uk-pagination uk-margin-large-top">';
            ...
            if ($page > 1) {
                ...
                $output[] = '<li><a data-icon="&#xe07a;" href="' . $link . '"></a></li>';
            }
            ...
            if ($page < $pages) {
                $link     = ($type === 'posts') ? get_pagenum_link($page + 1) : get_comments_pagenum_link($page + 1);
                $output[] = '<li><a data-icon="&#xe079;" href="' . $link . '"></i></a></li>';
            }
    ...
    add_action('paginate_my_plugin','ang_warp_pagination', 1);
