        ...
        <div class="uk-container uk-container-center uk-text-right">
            <div class="uk-width-small-1-2 uk-push-1-2">
                ...
                <div class="uk-clearfix">
                    <h3 class="uk-h3 slide-head-2 tm-slide-style-2 uk-float-right" data-uk-scrollspy="{cls:'uk-animation-slide-right'}">
                        <?php if($p_link1 != true){ ?>
                ...
                <?php   if ($p_excerpt1 != true){ ?>
                    <div class="uk-clearfix">
                        <div class="ang-slider-excerpt uk-display-inline-block tm-slide-style-2  uk-float-right ang-anim-duration-1-5" style="max-width:750px" data-uk-scrollspy="{cls:'uk-animation-slide-left'}">
                            <p>
                ...
                <?php   if($p_address1 != true && in_array($post->post_type, $epl_posts)){ ?>
                    <div class="uk-clearfix">
                        <h5 class="ang-slider-address uk-h6 slide-head-2 tm-slide-style-2 uk-float-right ang-anim-duration-1" data-uk-scrollspy="{cls:'uk-animation-slide-left'}"><i class="uk-icon-map-marker"></i><?php do_action('epl_property_address'); ?></h5>
                    </div>
                <?php } ?>
                <?php   if($p_price1 != true && in_array($post->post_type, $epl_posts)){ ?>
                    <div class="uk-clearfix">
                        <h5 class="ang-slider-price uk-float-right slide-head-2 tm-slide-style-2" data-uk-scrollspy="{cls:'uk-animation-slide-right'}"><?php do_action('epl_property_price'); ?></h5>
                    </div>
                <?php } ?>
            </div>
        </div>
