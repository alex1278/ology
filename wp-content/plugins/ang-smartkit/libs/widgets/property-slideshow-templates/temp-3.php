    ...
    <div class="uk-vertical-align-middle uk-text-center uk-width-1-1">
        <div class="tm-slide-style-1">
            ...
            <?php if($p_title1 != true){ ?>
                <h3 class="uk-h3 tm-slide-head ang-anim-duration-1-5" data-uk-scrollspy="{cls:'uk-animation-slide-right'}">
                    <?php if($p_link1 != true){ ?>
            ...
            <?php   if ($p_excerpt1 != true){ ?>
                    <div class="ang-slider-excerpt ang-anim-duration-3" data-uk-scrollspy="{cls:'uk-animation-scale-up'}">
                        <p>
            ...
            <?php   if($p_address1 != true && in_array($post->post_type, $epl_posts)){ ?>
                    <h5 class="ang-slider-address uk-h6 ang-anim-duration-4" data-uk-scrollspy="{cls:'uk-animation-scale-up'}"><i class="uk-icon-map-marker"></i><?php do_action('epl_property_address'); ?></h5>
            <?php } ?>
            <?php   if($p_price1 != true && in_array($post->post_type, $epl_posts)){ ?>
                    <h5 class="ang-slider-price ang-anim-duration-1-5" data-uk-scrollspy="{cls:'uk-animation-slide-left'}"><?php do_action('epl_property_price'); ?></h5>
            <?php } ?>
            </div>
        </div>
    </div>
