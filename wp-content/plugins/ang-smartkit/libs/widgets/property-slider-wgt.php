...
class EstaPropertySlider extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __('ANG Property Slider', 'text_domain'), // Name
            array( 'description' => __( 'Widget, displays property in slider style.', 'text_domain' ), ) // Args
        );
    }
...
if ( in_array( 'easy-property-listings/easy-property-listings.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
    add_action('widgets_init', create_function('', 'return register_widget("EstaPropertySlider");'));
}
