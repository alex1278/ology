<article id="item-<?php the_ID(); ?>" <?php post_class('uk-article art-blogger'); ?> data-permalink="<?php the_permalink(); ?>">
    <!--article hover-->
        ...
        <div class="flipper">
            ...
            <div class="front">
                <div class="uk-grid uk-grid-collapse">
                    <div class="uk-width-medium-2-3 ang-meta-container uk-flex uk-flex-column uk-flex-space-between">
                        <div>
                ...
                ?>
                    <div class="uk-width-medium-1-3 uk-position-relative art-pseudo-div">
                ...
                <?php else: ?>
                    ...
                    <div class="uk-width-medium-1-3 uk-position-relative ang-noimage">
            ...
            <!-- back content -->
            <div class="back">
                <div class="uk-width-1-1 uk-height-1-1 ang-meta-container uk-flex uk-flex-middle">
                    <blockquote class="uk-text-left">
                        ...
                        <?php 
                            ...
                            // define templates for 'WooCommmerce' plugin
                                ...
                                // Add to cart
                                print "<div class='uk-margin-top ang-woo-cart'>";
