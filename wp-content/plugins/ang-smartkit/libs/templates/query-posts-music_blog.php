<article id="item-<?php the_ID(); ?>" <?php post_class('uk-article music-blogger'); ?> data-permalink="<?php the_permalink(); ?>">
    <div class="ang-content-border">
        <div class=" uk-grid uk-grid-width-medium-1-2  uk-position-relative uk-overflow-hidden">
        <?php if (has_post_thumbnail()) : ?>
            ...
            ?>
                <div class="uk-position-relative">
                    <a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>">
                        <?php the_post_thumbnail('music-blog-loop', array('class' => '')); ?>
            ...
            <?php endif; ?>
            <div class="ang-meta-container uk-flex uk-flex-column uk-flex-space-between">
                <div>
