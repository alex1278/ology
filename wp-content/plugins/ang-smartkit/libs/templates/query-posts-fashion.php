...
?>
    <article id="item-<?php the_ID(); ?>" <?php post_class('uk-article template-fashion'); ?> data-permalink="<?php the_permalink(); ?>">
    ...
    <?php if (has_post_thumbnail()) : ?>
		...
		$client = get_post_meta( $post_id, '_tzp_portfolio_client', true);
                ...
                if ( shortcode_exists( 'WPCR_SHOW' ) ) {
                    echo do_shortcode("[WPCR_SHOW POSTID={$post_id} NUM='0' PAGINATE='0' PERPAGE='1' SHOWFORM='0' HIDEREVIEWS='1' HIDERESPONSE='1' SNIPPET='3' MORE='' HIDECUSTOM='1']");
                }
            ?>
