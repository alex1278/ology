    ...
    $.fn.pgwSlideshow = function(options) {
        ...
        var setup = function() {
            ...
            pgwSlideshow.plugin.find('.ps-list > ul > li').each(function() {
                ...
                if (element.link) {
                    currentElement.html('<a href="' + element.link + '"' + (element.linkTarget ? ' target="' + element.linkTarget + '"' : '') + 'data-uk-lightbox="{' + element.DataUkLightbox + '-x\'}' + '"' +  'data-lightbox-type="' + element.DataLightboxType + '"' + 'title="' + element.Datatitle + '"' + '>' + currentElement.html() + '</a>');
                }
        ...
        var getElement = function(obj) {
            ...
            if ((typeof elementLink != 'undefined') && (elementLink != '')) {
                ...
                //ang
                var elementDataUkLightbox = obj.find('a').attr('data-uk-lightbox');
                if ((typeof elementDataUkLightbox != 'undefined') && (elementDataUkLightbox != '')) {
                    element.DataUkLightbox = elementDataUkLightbox;
                }
                var elementDataLightboxType = obj.find('a').attr('data-lightbox-type');
                if ((typeof elementDataLightboxType != 'undefined') && (elementDataLightboxType != '')) {
                    element.DataLightboxType = elementDataLightboxType;
                }
                var elementTitle = obj.find('a').attr('title');
                if ((typeof elementTitle != 'undefined') && (elementTitle != '')) {
                    element.Datatitle = elementTitle;
                }//ang
            }
