...
function ology_post_meta_date_shortcode() {
	...
	echo ology_output( 'ology_post_meta_date_prefix', esc_html__( 'Posted on ', 'torbara' ) );
...
function ology_post_meta_author_shortcode() {
	...
	ology_output( 'ology_post_meta_author_prefix', esc_html__( 'By ', 'torbara' ) ) ;
...
function ology_post_meta_comments_shortcode() {
	...
	if ( $comments_number < 1 )
		$comment_text = ology_output( 'ology_post_meta_empty_comment_text', esc_html__( 'Leave a comment', 'torbara' ) );
	else if ( $comments_number === 1 )
		$comment_text = ology_output( 'ology_post_meta_comments_text_singular', esc_html__( '1 comment', 'torbara' ) );
	else
		$comment_text = ology_output( 'ology_post_meta_comments_text_plurial', esc_html__( '%s comments', 'torbara' ) );
...
function ology_post_meta_tags_shortcode() {
	...
	echo ology_output( 'ology_post_meta_tags_prefix', esc_html__( 'Tagged with: ', 'torbara' ) ) . $tags;
...
function ology_post_meta_categories_shortcode() {
	...
	echo ology_output( 'ology_post_meta_categories_prefix', esc_html__( 'Filed under: ', 'torbara' ) ) . $categories;
